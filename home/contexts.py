...
def address_context(request):
    ...
    in Admin
    """
    business_location = 'https://www.google.com/maps/place/'\
                        'Caf%C3%A9+Pascal/@59.3421357,17.98'\
                        '61722,13z/data=!4m9!1m2!2m1!1scoff'\
                        'ee+places+in+stockholm!3m5!1s0x465'\
                        'f77f743aac9cb:0xc16f1d3ee86dc04e!8'\
                        'm2!3d59.3421024!4d18.0519734!15sCh'\
                        'pjb2ZmZWUgcGxhY2VzIGluIHN0b2NraG9s'\
                        'bVoVIhNjb2ZmZWUgaW4gc3RvY2tob2xtkg'\
                        'EEY2FmZZoBI0NoWkRTVWhOTUc5blMwVkpR'\
                        'MEZuU1VReU5rMTZhMHRCRUFF' #noqa
